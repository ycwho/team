...
//Methods to send to server:
    ...
    // 2) Protocol.CLIENT_UPLOAD_SHIP_POSITIONS; - to upload the positions, send the string to the server: Protocol.CLIENT_UPLOAD_SHIP_POSITIONS + "," + playerName + "," + optionName + ",s1p1 s1p2 s1p3 s1p4 s1p5-s2p1 s2p2 etc.........
